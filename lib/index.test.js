...
describe('denormalizer', function () {
  ...
  it('should push, and remove', async function () {
    ...
    var id1 = await dogs.push(aDog);
    var id2 = await dogs.push(aDog);
  ...
  it('should push and update', async function () {
    dogs.filterableProperty('type');
    dogs.filterableProperty('kennel');
  ...
  it('should push and set', async function () {
    dogs.filterableProperty('type');
    dogs.filterableProperty('kennel');
  ...
  describe('findValue', function () {
    ...
    it('should find by properties', async function () {
      dogs.filterableProperty('type');
      dogs.filterableProperty('kennel');
