...
function firebaseDenormalizer(firebase) {
  ...
  return function modelDenormalizer(modelName) {
    var nonFilterableProperty = function () {
      var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(propName) {
    ...
    var setById = function () {
      var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(id, payload) {
    ...
    var set = function () {
      var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(path, payload) {
        var pathRef;
    ...
    var updateById = function () {
      var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(id, payload) {
    ...
    var update = function () {
      var _ref6 = _asyncToGenerator(regeneratorRuntime.mark(function _callee6(path, payload) {
    ...
    var remove = function () {
      var _ref8 = _asyncToGenerator(regeneratorRuntime.mark(function _callee8(path) {
        var pathObject, pathRef;
    ...
    var get = function () {
      var _ref10 = _asyncToGenerator(regeneratorRuntime.mark(function _callee10(path) {
        var snapshot;
    ...
    var onValue = function () {
      var _ref11 = _asyncToGenerator(regeneratorRuntime.mark(function _callee11(resultEventEmitter, result) {
    ...
    var filterByDenormalizedProperty = function () {
      var _ref12 = _asyncToGenerator(regeneratorRuntime.mark(function _callee12(modelName, filterKey, filterValue) {
    ...
    var filterByNonDenormalizedProperty = function () {
      var _ref13 = _asyncToGenerator(regeneratorRuntime.mark(function _callee13(modelName, filterKey, filterValue) {
        var path, snapshot;
    ...
    var actionOnFilterables = function () {
      var _ref14 = _asyncToGenerator(regeneratorRuntime.mark(function _callee14(modelName, payload, action) {
